...
public:
  ...
  // Constructor
  LidarNode(const std::string& node_name)
  : Node(node_name)
  {
    ...
    else 
    {
      RCLCPP_ERROR(
        this->get_logger(),
        "Error initializing YDLIDAR Comms and Status!!!");
    }
...
private:
  ...
  // LaserScan publihser
  rclcpp::Publisher<LaserScanMsg>::SharedPtr _laser_scan_pub;
  // Wall timer
...
int main(int argc, char* argv[])
{
  ...
  const std::string node_name = "ydlidar_driver";
